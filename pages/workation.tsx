...
const pics = ["/img/chicago.jpg", "/img/beach-work.jpg", "/img/miami.jpg", "/img/seattle.jpg"]
const Workation: React.FC<ComponentProps<any>> = (props) => {
    return (
        <div id="app" className="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen">
            <SideHeader className="xl:flex-shrink-0"/>
            <div className="xl:flex-1 xl:flex">
                <SearchFilter/>
                <main className="py-6 xl:flex-1 xl:overflow-y-hidden">
                    <div className="px-4">
                        <h3 className="text-gray-900 text-xl">Los Angeles</h3>
                        <p className="text-gray-600">Live like the starts in these luxurious Southern California
                            estates.</p>
                    </div>
                        ...
                        <div className="px-4 sm:inline-flex sm:pb-8">
                            {
                                pics.map((pic, index) => (
                                    <div
                                        className={classNames("sm:w-80 sm:flex-shrink-0  sm:px-2 sm:mt-0", {"mt-10": index > 0})}>
                            ...
                            <span
                                className="inline-block px-2 py-1 leading-none bg-teal-200 text-teal-800 font-semibold rounded-full uppercase tracking-wide text-xs">Plus</span>
                                                ...
                                                <h4 className="text-gray-900 font-semibold text-lg">Modern home in city
                                                    center</h4>
                                                <div className="mt-1">
                                                ...
                                                <div className="mt-2 flex items-center text-sm text-gray-600">
                                                    <svg className="w-4 h-4 text-teal-500 fill-current"
