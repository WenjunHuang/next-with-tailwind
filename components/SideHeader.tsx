        ...
        <header className="bg-gray-900 sm:flex sm:items-center sm:justify-between">
            ...
            <nav className={classNames("sm:flex sm:items-center", {"hidden": !isOpen, "block": isOpen})}>
                <div className="px-2 pt-2 pb-5 border-b border-gray-800 sm:flex sm:border-0 sm:py-0">
                    <a href="#" className="block py-1 px-3 rounded leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 ">List
                        your
                        property</a>
                    <a href="#"
                       className="mt-1 sm:mt-0 py-1 px-3 rounded block leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Tips</a>
                    <a href="#"
                       className="mt-1 sm:mt-0 py-1 px-3 rounded block leading-tight font-semibold text-white hover:bg-gray-800 sm:text-sm sm:px-2 sm:ml-2">Messages</a>
                </div>
                <div className="px-5 py-3 sm:py-0">
                    <div className="flex items-center">
                        <img className="h-10 w-10 object-cover rounded-full border-2 border-gray-600 sm:h-8 sm:w-8"
