    ...
    return (
        <header className="bg-gray-900">
            ...
            </div>
            {
                isOpen ?
                    <nav>
                        <div className="px-2 pt-2 pb-5 border-b border-gray-100">
                            <a href="#" className="block py-1 px-3 rounded font-semibold text-white hover:bg-gray-800">List
                                your
                                property</a>
                            <a href="#"
                               className="mt-1 py-1 px-3 rounded block leading-tight font-semibold text-white hover:bg-gray-800">Tips</a>
                            <a href="#"
                               className="mt-1 py-1 px-3 rounded block leading-tight font-semibold text-white hover:bg-gray-800">Messages</a>
                        </div>
